...
const KeyFeatures = () => {
    ...
    <div className="py-16 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Content */}
          <div>
            <p className="text-sm font-semibold text-pink-600 uppercase tracking-wide mb-4">Key Features</p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">Top Quality Services</h3>
                  <p className="text-gray-600">We deliver only the best services to our customers.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Book and manage your trips with ease and flexibility.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">Discounted Coupons</h3>
                  <p className="text-gray-600">Get amazing discounts and offers on all bookings.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <img
    ...
    className="w-80 h-[480px] object-cover rounded-[196px]"
  />

  {/* Small circle image at bottom right */}
